...
pipeline {
    ...
    stages {
		...
		dir('envBazel') {		    
		    ...
		    sh "docker image tag tmc-bazel-env test.trainamon.com/v2/$buildBazelEnvImageName"
		    sh "docker push test.trainamon.com/v2/$buildBazelEnvImageName"
		    sh "docker rmi test.trainamon.com/v2/$buildBazelEnvImageName"
		}
            }
        }
