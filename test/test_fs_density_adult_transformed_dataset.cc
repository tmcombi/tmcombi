#define BOOST_TEST_MODULE test_fs_density_adult_transformed_dataset
#include <boost/test/included/unit_test.hpp>

//#define TIMERS
//#define TRACE_EVALUATOR

#include "../lib/classifier_creator_fs_density.h"
#include "../lib/classifier_creator_train_tmc.h"


BOOST_AUTO_TEST_CASE( test_fs_density_adult_transformed  ) {
