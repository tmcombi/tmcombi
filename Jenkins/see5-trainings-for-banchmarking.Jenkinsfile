    ...
    stages {
       ...
       stage('see5 adult orig') {
            steps {
		        ...
		        sh 'docker run --rm -v $(pwd)/../data-manipulations:/workspace -w /workspace c50 /c5.0 -t 8 -f adult'
		        sh 'docker run --rm -v $(pwd)/../data-manipulations:/workspace -w /workspace c50 /c5.0 -t 16 -f adult'
		        sh 'docker run --rm -v $(pwd)/../data-manipulations:/workspace -w /workspace c50 /c5.0 -t 32 -f adult'
       ...
       stage('see5 adult transformed') {
            steps {
		        ...
		        sh 'docker run --rm -v $(pwd)/../data-manipulations:/workspace -w /workspace c50 /c5.0 -t 8 -f adult_transformed'
		        sh 'docker run --rm -v $(pwd)/../data-manipulations:/workspace -w /workspace c50 /c5.0 -t 16 -f adult_transformed'
		        sh 'docker run --rm -v $(pwd)/../data-manipulations:/workspace -w /workspace c50 /c5.0 -t 32 -f adult_transformed'
