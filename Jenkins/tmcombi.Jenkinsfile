       ...
       stage('Build-CMake-Env-Docker') {
        ...
        stage('Unit-Test') {
            steps {
		        ...
		        sh 'bin/test_induced_graph      --log_format=XML --log_sink=bin/results_induced_graph.xml      --log_level=all --report_level=detailed'
		        sh 'bin/test_sample_partitioner --log_format=XML --log_sink=bin/results_sample_partitioner.xml --log_level=all --report_level=detailed'
